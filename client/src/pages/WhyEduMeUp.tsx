    ...
    <Layout>
      ...
      <div className="w-full lg:px-8 lg:grid lg:grid-cols-[260px_1fr] gap-8 lg:gap-12 items-start pt-8 md:pt-12">
        ...
        <aside className={ui.cards.standard + " sticky top-24 hidden lg:block rounded-[2rem] p-5 shadow-sm h-fit"}>
          ...
          <div className="space-y-1">
            {[
              ...
              ["#step-1", "The 8 Steps"],
              ["#step-1", "— Step 1: Diagnostic"],
              ["#step-2", "— Step 2: Remedial"],
              ["#step-3", "— Step 3: Bridge"],
              ["#step-4", "— Step 4: H5P Learning"],
              ["#step-5", "— Step 5: Past Papers"],
              ["#step-6", "— Step 6: Retrieval"],
              ["#step-7", "— Step 7: Formative"],
              ["#step-8", "— Step 8: Mock Exams"],
              ["#course-types", "Course Types"],
              ["#stakeholders", "For Each Stakeholder"],
        ...
        <main className="min-w-0 space-y-0">
          ...
          <section id="two-systems" className="py-16 md:py-24 bg-[#FFF8EC] -mx-4 sm:-mx-6 lg:mx-0 px-4 sm:px-6 lg:px-0">
